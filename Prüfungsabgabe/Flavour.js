...
var IceShop;
(function (IceShop) {
    class Flavour extends IceShop.IceCream {
        drawOrder() {
            if (onclick)
                Choco;
            {
